...
console.log(clientSecret)
  ...
  return (
    <>
      ...
      <Navbar1 />
        <h1 data-aos="zoom-in" className='text-center text-gray-400 text-3xl'>| Subscribe |</h1>
        
        <div className='flex justify-center items-center mx-auto'>
          <div data-aos="flip-left" className="max-w-xl p-6 bg-gray-100 border border-gray-300 rounded-lg  "
